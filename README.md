# Deploy Cloud Functions with GitHub Actions & Service Account Credentials 🚀
...
This GitHub Action was forked from [FirebaseExtended/action-hosting-deploy](https://github.com/FirebaseExtended/action-hosting-deploy), which is a supported Firebase product. We have made some modifications to the original code to better suit our needs for deploying cloud functions.
